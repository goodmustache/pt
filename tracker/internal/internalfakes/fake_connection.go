...
func (fake *FakeConnection) Make(arg1 *internal.Request, arg2 *internal.Response) error {
	fake.makeMutex.Lock()
...
func (fake *FakeConnection) MakeCalls(stub func(*internal.Request, *internal.Response) error) {
	fake.makeMutex.Lock()
	defer fake.makeMutex.Unlock()
	fake.MakeStub = stub
}

func (fake *FakeConnection) MakeArgsForCall(i int) (*internal.Request, *internal.Response) {
	fake.makeMutex.RLock()
	defer fake.makeMutex.RUnlock()
